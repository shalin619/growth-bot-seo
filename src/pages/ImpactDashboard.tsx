...
const ImpactDashboard = () => {
  ...
  const [kwSort, setKwSort] = useState<{
    key: keyof KeywordRow;
    dir: "asc" | "desc";
  }>({
    key: "estTraffic",
    dir: "desc"
  });
  const [pgSort, setPgSort] = useState<{
    key: keyof PageRow;
    dir: "asc" | "desc";
  }>({
    key: "after",
  ...
  const keywordRows = useMemo<KeywordRow[]>(() => {
    const base: KeywordRow[] = [{
      keyword: "organic cotton hoodie",
      oldPos: 14,
      newPos: 5,
      volume: 5200,
      estTraffic: 240
    }, {
      keyword: "winter boots for women",
      oldPos: 8,
      newPos: 2,
      volume: 3800,
      estTraffic: 340
    }, {
      keyword: "sustainable yoga leggings",
      oldPos: 22,
      newPos: 12,
      volume: 2900,
      estTraffic: 120
    }, {
      keyword: "vegan leather backpack",
      oldPos: 17,
      newPos: 9,
      volume: 4100,
      estTraffic: 210
  ...
  const pageRows = useMemo<PageRow[]>(() => {
    const base: PageRow[] = [{
      ...
      visitsBefore: 820,
      visitsAfter: 1430,
      conversionImpact: "+$1,240/mo"
    }, {
      url: "/collections/winter-boots",
      before: 70,
      after: 88,
      visitsBefore: 1200,
      visitsAfter: 1920,
      conversionImpact: "+$1,760/mo"
    }, {
      url: "/products/vegan-leather-backpack",
      before: 58,
      after: 80,
      visitsBefore: 640,
      visitsAfter: 1100,
      conversionImpact: "+$860/mo"
    }, {
      url: "/blog/how-to-choose-yoga-leggings",
      before: 65,
      after: 79,
      visitsBefore: 450,
      visitsAfter: 770,
      conversionImpact: "+$420/mo"
    }];
  ...
  function downloadPdf() {
    toast({
      ...
      description: "PDF export will be available soon. Downloading JSON for now."
    });
  ...
  return <>
      ...
      <main className="container py-8 space-y-8">
        ...
        <section>
          <Card>
            <CardHeader>
              <CardTitle>Trends Ranking</CardTitle>
            </CardHeader>
            <CardContent className="h-[320px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={rankingSeries} margin={{
                left: 12,
                right: 12
              }}>
        ...
        <section>
          <Card>
            ...
            <CardContent className="h-[360px]">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={trafficSeries} margin={{
                left: 12,
                right: 12
              }}>
                  <CartesianGrid strokeDasharray="3 3" />
                    ...
                    return <TableRow key={r.url}>
                          ...
                          <TableCell>
                            <div className="w-40">
                              ...
                              width: `${Math.min(100, imp / 100 * 100)}%`
                            }} />
                              </div>
  ...
  return <Card className="animate-fade-in">
      <CardContent className="pt-6">
        ...
        <div className="mt-1 flex items-center gap-2 text-2xl font-semibold tracking-tight">
          {value}
          {trend === "up" ? <ArrowUpRight className="h-5 w-5 text-primary" /> : <ArrowDownRight className="h-5 w-5 text-destructive" />}
        </div>
